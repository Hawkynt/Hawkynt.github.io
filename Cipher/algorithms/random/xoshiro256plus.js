...
(function (root, factory) {
  ...
  class Xoshiro256PlusAlgorithm extends RandomGenerationAlgorithm {
    constructor() {
      super();

      // Required metadata
      this.name = "Xoshiro256+";
      this.description = "Xoshiro256+ is the fastest variant in the xoshiro256 family, using simple addition for the output function. It provides excellent speed but lower statistical quality compared to ++ and ** variants, making it suitable for floating-point generation using upper bits.";
      ...
      // Validated against reference C implementation at https://prng.di.unimi.it/xoshiro256plus.c
      this.tests = [
        {
          text: "Seed=0: First four 64-bit outputs from xoshiro256+",
          uri: "https://prng.di.unimi.it/xoshiro256plus.c",
          input: null,
          ...
          // Output sequence: 0xdaac60e1ed6a4f9b, 0x3156a1da0dc08435, 0xf9ba3e3285d046ab, 0x4fd194611dba7b01
          expected: OpCodes.Hex8ToBytes("9b4f6aede160acda3584c00ddaa15631ab46d085323ebaf9017bba1d6194d14f")
        },
        {
          ...
          // Output sequence: 0x02cbb47d774525cc, 0xe2cdc0c24434ab26, 0x288fe817477f7807, 0xb8c933a442343bd9
          expected: OpCodes.Hex8ToBytes("cc2545777db4cb0226ab3444c2c0cde207787f4717e88f28d93b3442a433c9b8")
        },
        {
          ...
          // Output sequence: 0x4f2790d70610546a, 0xd2ae33f21d5120ec, 0xa28f6ee203d01e40, 0x213ef47a5a3a7584
          expected: OpCodes.Hex8ToBytes("6a541006d790274fec20511df233aed2401ed003e26e8fa284753a5a7af43e21")
        }
      ];
    }
   ...
   */
    ...
    CreateInstance(isInverse = false) {
      ...
      return new Xoshiro256PlusInstance(this);
    }
  }

  /**
 * Xoshiro256Plus cipher instance implementing Feed/Result pattern
 * @class
 * @extends {IBlockCipherInstance}
 */

  class Xoshiro256PlusInstance extends IRandomGeneratorInstance {
    ...
    _next64() {
      ...
      // Output function: result = s[0] + s[3]
      const result = OpCodes.ToQWord(this._s0 + this._s3);
  ...
  // Register algorithm
  const algorithmInstance = new Xoshiro256PlusAlgorithm();
  if (!AlgorithmFramework.Find(algorithmInstance.name)) {
    RegisterAlgorithm(algorithmInstance);
  }

  return { Xoshiro256PlusAlgorithm, Xoshiro256PlusInstance };
}));
