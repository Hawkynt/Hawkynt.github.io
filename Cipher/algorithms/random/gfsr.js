 ...
 * - Four-tap recurrence: x[i] = x[i-p] ^ x[i-q] ^ x[i-r] ^ x[i-s]
 ...
 * - Kirkpatrick, S. & Stoll, E. "A Very Fast Shift-Register Sequence Random
  ...
  class GFSRAlgorithm extends RandomGenerationAlgorithm {
    constructor() {
      ...
      this.documentation = [
        ...
        new LinkItem(
          "Lewis & Payne: Generalized Feedback Shift Register Algorithm (1973)",
        ...
        new LinkItem(
          "Kirkpatrick & Stoll: Very Fast Shift-Register Sequence RNG (1981)",
 ...
 */
  ...
  class GFSRInstance extends IRandomGeneratorInstance {
     ...
     * Implements: x[i] = x[i-521] ^ x[i-353] ^ x[i-168] ^ x[i-32]
     */
    _next32() {
      if (!this._ready) {
