...
(function (root, factory) {
  ...
  /**
 * ReedSolomon cipher instance implementing Feed/Result pattern
 * @class
 ...
 */
  ...
  // ===== REGISTRATION =====
    ...
    const algorithmInstance = new ReedSolomonAlgorithm();
  ...
  return { ReedSolomonAlgorithm, ReedSolomonInstance };
}));