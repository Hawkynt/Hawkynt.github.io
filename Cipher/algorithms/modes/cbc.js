  ...
  constructor() {
    ...
    this.tests = [
      new TestCase(
        ...
        OpCodes.Hex8ToBytes("7649abac8119b246cee98e9b12e9197d"), // Expected CBC output
        "NIST SP 800-38A CBC single block",
        "https://nvlpubs.nist.gov/nistpubs/Legacy/SP/nistspecialpublication800-38a.pdf"
      ),
      new TestCase(
        OpCodes.Hex8ToBytes("6bc1bee22e409f96e93d7e117393172aae2d8a571e03ac9c9eb76fac45af8e5130c81c46a35ce411e5fbc1191a0a52eff69f2445df4f9b17ad2b417be66c3710"), // 4 blocks
        OpCodes.Hex8ToBytes("7649abac8119b246cee98e9b12e9197d5086cb9b507219ee95db113a917678b273bed6b8e3c1743b7116e69e222295163ff1caa1681fac09120eca307586e1a7"), // Expected multi-block
        "NIST SP 800-38A CBC multi-block",
        "https://nvlpubs.nist.gov/nistpubs/Legacy/SP/nistspecialpublication800-38a.pdf"
      )
    ];
...
const cbcAlgorithm = new CbcAlgorithm();
RegisterAlgorithm(cbcAlgorithm);

// Export for module systems
if (typeof module !== 'undefined' && module.exports) {
  module.exports = cbcAlgorithm;
}