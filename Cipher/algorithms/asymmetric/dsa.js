...
(function (root, factory) {
  ...
  class DSASignature extends AsymmetricCipherAlgorithm {
    constructor() {
      ...
      // NIST CAVP, FIPS 186-4 SigVer, the [mod = L=3072, N=256, SHA-256]
      // group. RFC 6979 stops at a 2048-bit p, so the third declared parameter
      // set has no signing vector anywhere; CAVP publishes verification cases
      // for it, and a verification case pins the modular exponentiation, the
      // reduction mod q and the r || s split just as a signing case does.
      const CAVP = "https://csrc.nist.gov/CSRC/media/Projects/Cryptographic-Algorithm-Validation-Program/documents/dss/186-3dsatestvectors.zip";

      const P3072 =
        "BB24FEDE78690B2C7C0FE5C834EF526B9A40BFC938D8AB960A79EBF37B8F6A8B" +
        "8B83F40AF3C65DC63653D21E84DB12B7AD1F1EDC3F8855BDC520E645B507B03E" +
        "A826F71C13A768D5DA98E10C73C402F4E14245FCA51EFBE6822D4F4E02E9F258" +
        "D35CBD2035DA74151FF3AC4479B5205571613C962527182026AE54E20C369A72" +
        "9DF90822FCFBACCF9A3EB276B47AD7CA6C77203E45D0D09920BA17F7C28DC0EA" +
        "0E1AEB64C2FF44A2CC5D27D0CFBF3798B35CFDCD2FEB33890F688428ACD6CA51" +
        "45AE3EE041BDE09C3491330F9058E2ACEE34111B4CC5F40FE2B6CF0FAF886C06" +
        "E3F19B141E8637DBB6A1F0462DB29B7C3657D071C6EB2CEEDBC43CB1EAD3C458" +
        "39C3170FA70A982FE5600A36A298899B9E4578361516AAEEB206906450EEC586" +
        "596EDBB1498E054C788212CEAFE0C8C32D26905A057209032F8ECD086FF905DD" +
        "46D31725DCCC7E0653F9C0C294BB510FB86DB661B90CD15DD653DC042D00A5DC" +
        "1D6AC84ECA31442B79985943C9EBAAF729E32F929284D90B5A995F39E35048D9";
      const Q3072 = "E28D323A9A6BE548B1DA7741EBB824BED875B281BF444C7674300B6D29510AA1";
      const G3072 =
        "A6A0B25AC52BAF98973B44F1003F46B6B245983760428C9BD1A1A175A26A957F" +
        "519ECABC9B3401A96509B3E4B2B1A78DF86819B5E015BD90F87F7CA694835627" +
        "26E379B13F5F6BB56121D16A2F5644C37A57151DA7888DDADCD6B623E04FFFF8" +
        "5C2EC283A3233C5B7D0F54F2FA68F106FAA71C1EFBB75685C07BE28E351A5737" +
        "FCC4697B2915DBCB8CC8D2DFC1A042ED8829DCC0F8E32E95F0C46B8A4E78DA07" +
        "F98DC1A2CC9572FFF4862F8C99954CE57B06056A30CBA5168E941276CFCAF03F" +
        "0C15852CAF70C70B70C5CE58ED4D2FB194373E785005933A2523BB75BCE76661" +
        "AC1B53F6C77A772AE4BFBC7FE05D1B16CFB841C02051D2454F45A2F2AF84A965" +
        "A0FF1C1A1027DFA745BA2D5B778A3AF1C92EE40772769930E9532F707D851548" +
        "5BABA1E0A2A7DA40ABA1C3A6AE68C8A59E4FB55793C91462F77D181013E9F4C8" +
        "2D47A4B65FAA9C2412BE4978E74A8F6759785120A4F7970A0B96C5A917AD5BCF" +
        "FBDB3ED35C0EA97FA1B3A0E0D7C09957700F8BF2D9B569E8EEE72CBC4192B626";
      ...
      this.tests = [
        ...
        {
          // NIST CAVP, the one valid vector in SigVer.rsp whose r begins with
          // a zero octet. r || s is a fixed-width encoding with no length
          // prefix, so the halves can only be told apart if that zero is
          // carried; a verifier that treats r as 31 significant octets reads s
          // one octet out of place and rejects a good signature.
          text: "NIST CAVP FIPS 186-4 SigVer - DSA 2048/256, SHA-384, r carries a leading zero octet",
          uri: "https://csrc.nist.gov/CSRC/media/Projects/Cryptographic-Algorithm-Validation-Program/documents/dss/186-3dsatestvectors.zip",
          p: "E7C1C86125DB9EF417DA1CED7EA0861BDAD629216A3F3C745DF42A46B989E59F" +
             "4D98425EE3C932FA3C2B6F637BDB6545BEC526FAA037E11F5578A4363B9FCA5E" +
             "BA60D6A9CBAA2BEFD04141D989C7356285132C2EAF74F2D868521CDC0A17AE9A" +
             "2546EF863027D3F8CC7949631FD0E2971417A912C8B8C5C989730DB6EA6E8BAE" +
             "E0E667850429038093C851CCB6FB173BB081E0EFE0BD7450E0946888F89F75E4" +
             "43AB93EF2DA293A01622CF43C6DD79625D41BA8F9EF7E3086AB39134283D8E96" +
             "C89249488120FD061E4A87D34AF41069C0B4FD3934C31B589CBE85B68B912718" +
             "D5DAB859FDA7082511FAD1D152044905005546E19B14AA96585A55269BF2B831",
          q: "8E056EC9D4B7ACB580087A6ED9BA3478711BB025D5B8D9C731EF9B38BD43DB2F",
          g: "DC2BFB9776786AD310C8B0CDCBBA3062402613C67E6959A8D8D1B05AAB636528" +
             "B7B1FE9CD33765F853D6DBE13D09F2681F8C7B1ED7886AAED70C7BD76DBE858F" +
             "FB8BD86235DDF759244678F428C6519AF593DC94EEADBD9852BA2B3D61664E8D" +
             "58C29D2039AF3C3D6D16F90988F6A8C824569F3D48050E30896A9E17CD0232EF" +
             "01AB8790008F6973B84C763A72F4AE8B485ABFB7E8EFEB86808FA2B281D3E5D6" +
             "5D28F5992A34C077C5AA8026CB2FBC34A45F7E9BD216B10E6F12ECB172E9A6EB" +
             "8F2E91316905B6ADD1FD22E83BC2F089F1D5E6A6E6707C18FF55DDCB7954E8BC" +
             "EAF0EFC4E8314910C03B0E51175F344FAAFEE476A373AC95743CEC712B72CF2E",
          y: "76818B55D221ECC73AF8027805AB26E028CFC5118755AC1E801E74C5AF5E3822" +
             "1C277CF5D05D4DAF6FC5339C09C952EA9537943E951B481521D591F44674F2D9" +
             "BE900CB67E206181CEE2EEDA8E35AB2E155D3450F0733FD4038BDDFAFE22379A" +
             "53B00CC1C38779E2A85A97E5B232A62A842F38F763034B3B2D14C803B64F8944" +
             "6971E137D1CA556163889A62CF285C2D176EB36CA4B252DA784299D735D65676" +
             "E65FED6BA46AD2F83AD944DEED49DCC17BDE8BABE4E78FEFFB6E4F37A49398AA" +
             "6B934FE95A5D2CA5A5AC31C6B50E3521DB45413A4DF32B57E9503C5DD5503F5F" +
             "8C59D9BD67AFB1A7E8C4476EE937656AD851E523F9722C7F74FF2FD600961EFE",
          hashAlgorithm: 'SHA-384',
          signature: OpCodes.Hex8ToBytes(
            "003E5C16F064EDF41ABFB1EF53FF2E87C22FEAC955FAD9DFB36660055BF0DF10" +
            "7FA8834B03784AFEC0D645EB3D33E15A622B751A0170731936E8DE5D2273D927"),
          input: OpCodes.Hex8ToBytes(
            "674D691DDAC961E3CB49DEB36943BC8F4924877F2BDA30C62902C65575525E61" +
            "61BDD0B5108D737C8C5AACE62AABC0080495345AD4A52FA9A3D1BED8686A31CB" +
            "0247519CDE350076976EC166E85B20EC3E1F8C3D7C184D9142A67A642CBACE70" +
            "DCB010F1D4C99E68182383FAB0A84BD55567A5F3A47CCEDA4164D435059881E1"),
          expected: [1]
        },
        {
        ...
        {
          // The 3072-bit parameter set. Without this the largest declared key
          // size was never run, and a reduction that only ever saw a 1024- or
          // 2048-bit p could break here without any vector noticing.
          text: "NIST CAVP FIPS 186-4 SigVer - DSA 3072/256, SHA-256, valid signature",
          uri: CAVP,
          p: P3072, q: Q3072, g: G3072,
          y: "B674A542A27590EDCAFC8DBA94F6506BAB95072E1B7245BF87C483D5F9E6E633" +
             "5ADD4AD9283C214D8E3344158CD20B86FF143A27F976F5C4D56DE71BB1609430" +
             "9F68C6F0F11C46DAB3A88DA3EC4A4BE35DE37467F6984448351B8B22E6388CFB" +
             "AB759290A8B9FA699354C981DE5379147CCED3797D89C0E3F8E22646387F500A" +
             "3F4F4675F918109CE707EE0B81D26EFB72998EF5C9F14F99C1A49553DF505C35" +
             "A1E555405B93FD65C280A8DA8ADC0B01E5C2A38AFC88A8846301B038A6E55B0B" +
             "130CA62EC248C6486357763CA7D6ADF377DB648FED21DF3A1633AE949194776D" +
             "7BC1A42FA3848B5855CD01DCAE3016FDBB43656EBD8DBC7CD584FFBD7199E7CC" +
             "B6CF00329DE19F48F679E71F982932B4422D5450C60862ED2FA78B2D01D0E7E3" +
             "18A0EAB15A214394E8CE0FA12F0E35D49760CB84CEE0757F44617413E6DE4F1B" +
             "F6EA780A76FBC6B71771B4F7CFA52DE5C596DBE76349E106929401B998B64334" +
             "23C5C863B1954ABE6D1569E3E680FEA6723C68993DFC24568C1B744DF2FA1003",
          hashAlgorithm: 'SHA-256',
          signature: OpCodes.Hex8ToBytes(
            "D69BB325A255A2C6990237D27D871093F3F9A1CF4BCEE333AB01C189ABED84E0" +
            "562B9E611160320AAFE7753B72E1D9935D128C2F2C0AE76E603C79D1692EEFA3"),
          input: OpCodes.Hex8ToBytes(
            "8598872B6DD3DBFE3D49369630105EF618580AFE74D459BAFD803D3DA76F5AC0" +
            "10E0D4AA113B1EE3B4D329E527DE99DF3D3BB65DC8E963D2D553AFB271D0600C" +
            "1FD2D8A36C7E5A58C5AB2838E1B9D362A60CC70851114471FEC89E83F80F1E17" +
            "AA4C794AB08C273A47F0C2AE7FE445B0063FC87E1FC0865482C636899856369D"),
          expected: [1]
        },
        {
          // The same group's "R changed" case. r is checked against the first
          // half of what the verifier recomputes, and an implementation that
          // compared only s - or compared nothing at all - would still pass the
          // valid vector above.
          text: "NIST CAVP FIPS 186-4 SigVer - DSA 3072/256, SHA-256, r altered so the signature must be rejected",
          uri: CAVP,
          p: P3072, q: Q3072, g: G3072,
          y: "1ECCDBA508455A1E08C7FDB8F9BB7599A7770DCEAC61391CF630C3ECD8BECCA8" +
             "F0E078D997DE6687D6B535AE3FAF5540AC7B62EB97FE9B8093610D85A096B291" +
             "94664F51CB249E2CB4C9BC72E46903608A17CCF2F43FB263661EDFC00C1C82FB" +
             "2CEAE9DD112E658ADFE536B456817BC82C7518B0C85DCD59E15CCFEBA5EC4064" +
             "82FE3ED192163AE520EDA84A1F0564F60CFFA26EDF2636FFCFB3949551A505B9" +
             "DEBA986087F7795B432FB403DA0167E1255EC979D24DBAC0D118AEEF21666D98" +
             "EBBDC72473565D0ACA16B1CEACE9BD15464DFE76FF60FE85E95DC70F3DB33256" +
             "AC29113BD2457704BB6E09612C3C08F0F68DDA4F0D52CBAE4A9FF3DBB078BA5F" +
             "DBD07A5A3688C407202644CBB8E64C7572DA7E42B8A38972557A726B25C112B0" +
             "B16BD06A42305C1748876836D68FD70AE8FCE8CA36B72026BFABE4480F3AAD81" +
             "4CEA7767225318ACD1665B559BF4EFFE06B153D19FAA9303B97036E403237B64" +
             "0B1C29D2D23B17510D59FB616C2266B876CCEB82A7FD350D3E242C83FCA74916",
          hashAlgorithm: 'SHA-256',
          signature: OpCodes.Hex8ToBytes(
            "BDFFD6B0BED0FC36F3E29B25F475B2E8F78D2B37E1F02C83525BD21228B521DE" +
            "2ED6571B366942D4D43A143B838C69A1632282A15D28D69E35CE547DD6DDBB9F"),
          input: OpCodes.Hex8ToBytes(
            "A9BC778C5F34420F3A6C212B5D9D68FE333FCBAF0F6F8AF7A6AB8EBFA72D22F6" +
            "444567DB3A2BF8DD6E84E0965DDA56FA291EE40ED739C8656F1F3CDAFC143370" +
            "4BA6DF1F61D8FC4D75DDF847876981908F916FEC295A35071A593C649A63D1C0" +
            "E58FBCAB339DAD05F738E716DD4C76C0969CF8FF2BEF3AE897D7F2A5CE51F7AF"),
          expected: [0]
        }
      ];
    }
