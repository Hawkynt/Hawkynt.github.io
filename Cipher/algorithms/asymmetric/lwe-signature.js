...
(function (root, factory) {
  ...
  /**
 * LWESignature cipher instance implementing Feed/Result pattern
 * @class
 ...
 */
  ...
  // ===== REGISTRATION =====
    ...
    const algorithmInstance = new LWESignatureCipher();
  ...
  return { LWESignatureCipher, LWESignatureInstance };
}));