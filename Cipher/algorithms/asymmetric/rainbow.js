...
(function (root, factory) {
  ...
  class RainbowAlgorithm extends AsymmetricCipherAlgorithm {
    constructor() {
      ...
      {type:"Beullens Rectangle Attack", text:"Complete cryptographic break - key recovery in hours/days on standard hardware"},
        {type:"Multivariate Structure Exploitation", text:"Rectangle attack exploits fundamental Rainbow layer structure"},
        {type:"All Parameter Sets Broken", text:"Attack applies to all Rainbow-I, Rainbow-III, and Rainbow-V parameter sets"}
      ];
  ...
  /**
 * Rainbow cipher instance implementing Feed/Result pattern
 * @class
 ...
 */
  ...
  // ===== REGISTRATION =====
    ...
    const algorithmInstance = new RainbowAlgorithm();
  ...
  return { RainbowAlgorithm, RainbowInstance };
}));