...
(function (root, factory) {
  ...
  class RainbowAlgorithm extends AsymmetricCipherAlgorithm {
    ...
    constructor(setName) {
      ...
      //
      // Measured over every Rainbow response file that the submission packages
      // publish, not only the entries committed here: all 100 entries of the
      // Rainbow-I circumzenithal file reproduce their public key, their secret
      // key and their signed message octet for octet, and so do the entries of
      // both Rainbow-V files that were retrieved. The submission ships no
      // response file at all for the other six of its nine parameter set and
      // key format combinations, and none for Rainbow-III in any form.
