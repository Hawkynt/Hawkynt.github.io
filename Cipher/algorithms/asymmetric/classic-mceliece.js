...
(function (root, factory) {
  ...
  /**
 * ClassicMcEliece cipher instance implementing Feed/Result pattern
 * @class
 ...
 */
  ...
  // ===== REGISTRATION =====
    ...
    const algorithmInstance = new ClassicMcElieceCipher();
  ...
  return { ClassicMcElieceCipher, ClassicMcElieceInstance };
}));