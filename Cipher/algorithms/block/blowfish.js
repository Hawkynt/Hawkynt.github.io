...
(function (root, factory) {
  ...
  /**
 * BlowfishAlgorithm - Block cipher implementation
 * @class
 ...
 */
      ...
      this.tests = [
        {
          ...
          expected: [0x4E, 0xF9, 0x97, 0x45, 0x61, 0x98, 0xDD, 0x78]
        },
        {
          ...
          expected: [0x51, 0x86, 0x6F, 0xD5, 0xB8, 0x5E, 0xCB, 0x8A]
        },
        {
          ...
          expected: [0x61, 0xF9, 0xC3, 0x80, 0x22, 0x81, 0xB0, 0x96]
        },
        {
          ...
          expected: [0x25, 0x32, 0xFA, 0x57, 0xD3, 0xAC, 0xF5, 0xC5]
        },
        {
          ...
          expected: [0x6E, 0x64, 0x56, 0x62, 0x68, 0x49, 0xCF, 0x27]
        }
      ];
    }
  ...
  /**
 * Blowfish cipher instance implementing Feed/Result pattern
 * @class
 ...
 */
   ...
   */
    ...
    _initConstants() {
      ...
      // Initialize proper S-box constants
      this._initProperSBoxes();
    }
  ...
  // ===== REGISTRATION =====
    ...
    const algorithmInstance = new BlowfishAlgorithm();
  ...
  return { BlowfishAlgorithm, BlowfishInstance };
}));