...
(function (root, factory) {
  ...
  class GostKuznyechikAlgorithm extends BlockCipherAlgorithm {
    constructor() {
      ...
      this.SupportedKeySizes = [
        new KeySize(32, 32, 0)  // GOST R 34.12-2015: 256-bit keys only
      ];
  ...
  // ===== REGISTRATION =====
    ...
    const algorithmInstance = new GostKuznyechikAlgorithm();
  ...
  return { GostKuznyechikAlgorithm, GostKuznyechikInstance };
}));