/*
 * Raiden (DarkCrypt variant, 32 rounds) Implementation
 ...
 * differs (32 instead of 16); both variants share this structure.
 *
...
(function (root, factory) {
  ...
  class DarkCryptRaiden32Algorithm extends BlockCipherAlgorithm {
    constructor() {
      super();
  ...
  const algorithmInstance = new DarkCryptRaiden32Algorithm();
  if (!AlgorithmFramework.Find(algorithmInstance.name)) {
    RegisterAlgorithm(algorithmInstance);
  }

  return { DarkCryptRaiden32Algorithm, DarkCryptRaiden32Instance };
}));
