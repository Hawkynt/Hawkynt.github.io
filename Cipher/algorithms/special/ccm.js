...
(function (root, factory) {
      ...
      this.tests = [
        {
          ...
          expected: [0xA9, 0x6E, 0x97, 0x16, 0x64, 0x58, 0xE4, 0x4C, 0xC4, 0x02, 0x52, 0xC4, 0x54, 0x66, 0x11, 0x6E]
        },
        {
          ...
          input: [0x41],
          key: [0x40, 0x41, 0x42, 0x43, 0x44, 0x45, 0x46, 0x47, 0x48, 0x49, 0x4A, 0x4B, 0x4C, 0x4D, 0x4E, 0x4F],
          expected: [0x8D, 0xAC, 0x6E, 0x97, 0x12, 0x64, 0x58, 0xE4, 0x4C, 0xC4, 0x02, 0x52, 0xC4, 0x54, 0x66, 0x11, 0x6E]
        }
      ];
    }
  ...
  // ===== REGISTRATION =====
    ...
    const algorithmInstance = new CcmAlgorithm();
  ...
  return { CcmAlgorithm, CcmAlgorithmInstance };
}));