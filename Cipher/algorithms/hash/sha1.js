...
(function(global) {
  ...
  class SHA1Algorithm extends HashFunctionAlgorithm {
    constructor() {
      ...
      // Required metadata
      this.name = "SHA-1";
      this.description = "Secure Hash Algorithm producing 160-bit digest. First SHA standard by NIST but now cryptographically broken due to collision attacks. Educational use only.";
      ...
      this.tests = [
        new TestCase([], OpCodes.Hex8ToBytes("da39a3ee5e6b4b0d3255bfef95601890afd80709"), "Empty string test vector", "https://tools.ietf.org/html/rfc3174"),
        new TestCase(OpCodes.AnsiToBytes("a"), OpCodes.Hex8ToBytes("86f7e437faa5a7fce15d1ddcb9eaeaea377667b8"), "Single character 'a' test vector", "https://tools.ietf.org/html/rfc3174"),
        new TestCase(OpCodes.AnsiToBytes("abc"), OpCodes.Hex8ToBytes("a9993e364706816aba3e25717850c26c9cd0d89d"), "String 'abc' test vector", "https://tools.ietf.org/html/rfc3174"),
        new TestCase(OpCodes.AnsiToBytes("message digest"), OpCodes.Hex8ToBytes("c12252ceda8be8994d5fa0290a47231c1d16aae3"), "Message 'message digest' test vector", "https://tools.ietf.org/html/rfc3174"),
        new TestCase(OpCodes.AnsiToBytes("abcdefghijklmnopqrstuvwxyz"), OpCodes.Hex8ToBytes("32d10c7b8cf96570ca04ce37f2a19d84240d3a89"), "Alphabet test vector", "https://tools.ietf.org/html/rfc3174")
      ];
    }
  ...
  class SHA1Instance extends IHashFunctionInstance {
    ...
    Final() {
      ...
      this.buffer.push(0x80); // Append bit '1' followed by zeros
