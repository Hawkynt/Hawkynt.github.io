 ...
 * (c)2006-2025 Hawkynt
 *
 * CSHAKE128 is a customizable extendable-output function (XOF) based on SHAKE128
...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CSHAKE128 = factory(root.AlgorithmFramework, root.OpCodes);
  }
}((function() {
  ...
  // CSHAKE128 parameters (same as SHAKE128)
  const RATE = 168;          // 1344 bits
  const ROUNDS = 24;
  ...
  class CSHAKE128Algorithm extends HashFunctionAlgorithm {
    constructor() {
      super();
      this.name = "CSHAKE128";
    ...
    CreateInstance(isInverse = false) {
      ...
      return new CSHAKE128Instance(this);
    }
  }

  class CSHAKE128Instance extends IHashFunctionInstance {
  ...
  const algorithmInstance = new CSHAKE128Algorithm();
  if (!AlgorithmFramework.Find(algorithmInstance.name)) {
    RegisterAlgorithm(algorithmInstance);
  }

  return { CSHAKE128Algorithm, CSHAKE128Instance };
}));
