/*
 * Keccak-384 Hash Function - Original Keccak submission
...
(function (root, factory) {
  ...
  class Keccak384Algorithm extends HashFunctionAlgorithm {
    constructor() {
      super();
      this.name = "Keccak-384";
    ...
    CreateInstance(isInverse = false) {
      ...
      return new Keccak384Instance(this);
    }
  }

  class Keccak384Instance extends IHashFunctionInstance {
  ...
  const algorithmInstance = new Keccak384Algorithm();
  if (!AlgorithmFramework.Find(algorithmInstance.name)) {
    RegisterAlgorithm(algorithmInstance);
  }

  return { Keccak384Algorithm, Keccak384Instance };
}));
