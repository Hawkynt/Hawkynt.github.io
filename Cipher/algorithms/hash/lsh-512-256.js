/*
 * LSH-512-256 - Korean Hash Function Standard (512-bit processing, 256-bit output)
 ...
 * Uses 512-bit internal processing with 256-bit output
...
(function (root, factory) {
  ...
  // Initial values for LSH-512-256 (16 x 64-bit words)
  ...
  class LSH512_256Algorithm extends HashFunctionAlgorithm {
    ...
    CreateInstance(isInverse = false) {
      ...
      return new LSH512_256Instance(this);
    }
  }

  class LSH512_256Instance extends IHashFunctionInstance {
    ...
    _init() {
      // Initialize with LSH-512-256 IV
      for (let i = 0; i < 8; i++) {
        this.cv_l[i] = LSH512_IV256[i];
        this.cv_r[i] = LSH512_IV256[i + 8];
      }
    ...
    Result() {
      ...
      // Extract 256-bit hash (4 x 64-bit words, little-endian)
  ...
  const algorithmInstance = new LSH512_256Algorithm();
  if (!AlgorithmFramework.Find(algorithmInstance.name)) {
    RegisterAlgorithm(algorithmInstance);
  }

  return { LSH512_256Algorithm, LSH512_256Instance };
}));
