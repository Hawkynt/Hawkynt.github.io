/*
 * SHA-3-512 Hash Function - FIPS 202 Standard
...
(function (root, factory) {
  ...
  class SHA3512Algorithm extends HashFunctionAlgorithm {
    constructor() {
      super();
      this.name = "SHA-3-512";
      this.description = "SHA-3-512 produces 512-bit digests using the Keccak sponge construction. Part of the NIST FIPS 202 standard.";
    ...
    CreateInstance(isInverse = false) {
      ...
      return new SHA3512Instance(this);
    }
  }

  class SHA3512Instance extends IHashFunctionInstance {
  ...
  const algorithmInstance = new SHA3512Algorithm();
  if (!AlgorithmFramework.Find(algorithmInstance.name)) {
    RegisterAlgorithm(algorithmInstance);
  }

  return { SHA3512Algorithm, SHA3512Instance };
}));
