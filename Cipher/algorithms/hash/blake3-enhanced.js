 ...
 */
  ...
  class BLAKE3Enhanced extends HashFunctionAlgorithm {
      constructor() {
        ...
        this.description = "Enhanced educational implementation of the BLAKE3 cryptographic hash function. Splits the message into 1024-byte chunks, hashes each to a chaining value and combines them with a binary Merkle tree of parent nodes, reproducing the official test vectors at every input length. The digest is extendable to any length.";
        ...
        this.tests = [
          ...
          // the subtree stack has to hold one completed pair while a third
          // chunk is still open. An implementation that ignores the chunk tree
          // passes everything up to 1024 and fails from 1025 on.
          {
          ...
          // bytes are the default digest. Anything past the first 64 bytes
          // needs the output block counter, and the second half of each
          // compression output is only exercised beyond byte 32.
          {
            text: "BLAKE3 Official Test Vector - 2049 bytes, 131 byte extended output",
            uri: "https://github.com/BLAKE3-team/BLAKE3/blob/master/test_vectors/test_vectors.json",
            input: officialVectorInput(2049),
            outputSize: 131,
            expected: OpCodes.Hex8ToBytes(
              ...
              "aae98764ca468962b5c2ec92f0c74eb5448d519713e09413719431c802f948dd" +
              "5d90425a4ecdadece9eb178d80f26efccae630734dff63340285adec2aed3b51" +
              "073ad3")
          }
        ];
      }
