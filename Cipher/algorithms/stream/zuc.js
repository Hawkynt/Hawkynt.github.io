 ...
 * 3GPP Confidentiality Algorithm 128-EEA3 and Integrity Algorithm 128-EIA3
 ...
 * - Keystream generation: Z = F() xor BRC[3]
 */
...
(function (root, factory) {
  ...
  /**
 * ZUCAlgorithm - Stream cipher implementation
 * @class
 ...
 */
  ...
  class ZUCAlgorithm extends StreamCipherAlgorithm {
    constructor() {
      ...
      this.references = [
        new LinkItem("GmSSL C Reference Implementation (ZUC/128-EEA3/128-EIA3)", "https://github.com/guanzhi/GmSSL")
      ];
  ...
  /**
 * ZUC cipher instance implementing Feed/Result pattern
 * @class
