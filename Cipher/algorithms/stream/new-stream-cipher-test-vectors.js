  ...
  'VEST': [
    {
      ...
      plaintextHex: OpCodes.Hex8ToBytes('48656c6c6f205645535421'),
    ...
    },
    {
      ...
      plaintext: 'Minimum',
      plaintextHex: OpCodes.Hex8ToBytes('4d696e696d756d'),
  ...
  'DRAGON': [
    {
      ...
      keyHex: OpCodes.Hex8ToBytes('4452414745204e207465737420206b65792121'),
      iv: 'DRAGON test IV!!',   // 16 bytes
      ivHex: OpCodes.Hex8ToBytes('4452414745204e207465737420204956212121'),
      plaintext: 'Hello DRAGON!',
      plaintextHex: OpCodes.Hex8ToBytes('48656c6c6f204452414745204e21'),
    ...
    },
    {
      ...
      keyHex: OpCodes.Hex8ToBytes('4452414745204e20323536372d626974207465737420206b657920666f722074657374696e67206c617267656b65797321'),
      iv: 'DRAGON IV for 256-bit key test!',
      ivHex: OpCodes.Hex8ToBytes('4452414745204e20495620666f7220323536372d626974206b6579207465737421'),
      plaintext: 'Large key test',
      plaintextHex: OpCodes.Hex8ToBytes('4c617267656b6579207465737'),
  ...
  'PIKE': [
    {
      ...
      keyHex: OpCodes.Hex8ToBytes('50494b45207465737420206b657921212121'),
      iv: 'PIKEiv64',           // 8 bytes
      ivHex: OpCodes.Hex8ToBytes('50494b45697636343'),
      plaintext: 'Fast PIKE!',
      plaintextHex: OpCodes.Hex8ToBytes('46617374205049b4521'),
    ...
    },
    {
      ...
      keyHex: OpCodes.Hex8ToBytes('50494b4520323536372d626974207465737420206b657920666f72206d6178696d756d20706572666f726d616e636520746573696e6720686572652'),
      iv: 'PIKEiv64',
      ivHex: OpCodes.Hex8ToBytes('50494b45697636343'),
      plaintext: 'Speed test',
      plaintextHex: OpCodes.Hex8ToBytes('537065656420746573747'),
  ...
  'Leviathan': [
    {
      ...
      keyHex: OpCodes.Hex8ToBytes('4c6576696174686e20323536372d626974207465737420206b657920666f72206c617267652073746174652063697068657220746573696e6720686572652'),
      iv: 'Leviathan 256-bit test IV for large state cipher testing!',
      ivHex: OpCodes.Hex8ToBytes('4c6576696174686e20323536372d626974207465737420204956206f72206c617267652073746174652063697068657220746573696e672'),
    ...
    },
    {
      ...
      plaintextHex: OpCodes.Hex8ToBytes('4e756c6c206b657920746573747'),
  ...
  'TSC-4': [
    {
      ...
      keyHex: OpCodes.Hex8ToBytes('545354343420746f7274757265206b657921'),
      iv: 'TSC4 torture IV!',    // 16 bytes
      ivHex: OpCodes.Hex8ToBytes('545343343420746f727475726520495621'),
      plaintext: 'Torture test!',
      plaintextHex: OpCodes.Hex8ToBytes('546f727475726520746573742'),
    ...
    },
    {
      ...
      ivHex: OpCodes.Hex8ToBytes('123456789abcdef00fedcba9876542321'),
      plaintext: 'High entropy',
      plaintextHex: OpCodes.Hex8ToBytes('486967682020656e747206f7079'),
  ...
  'HC-256': [
    {
      ...
      keyHex: OpCodes.Hex8ToBytes('48432d32353620746573206b657920666f7220323536372d626974206f7065726174696f6e7320616e64206c617267652074626c652073747265616d696e672'),
      ...
      plaintextHex: OpCodes.Hex8ToBytes('48432d32353620746162c6c6573'),
    ...
    },
    {
      ...
      keyHex: OpCodes.Hex8ToBytes('48432d32353620636f6e73697374656e637920746573742075206b657920666f722074616220626c652020696e697469616c697a6174696f6e20746573696e672'),
      ...
      plaintextHex: OpCodes.Hex8ToBytes('00000000000000000'),
