...
(function (root, factory) {
  ...
  // tree and the emitted code lengths - follows from the frequencies alone,
  // whatever internal shape the heap happens to take.
  class HuffmanQueue {
  ...
  function buildCodeLengths(frequencies, numSymbols, maxBits) {
    ...
    while (heap.count > 1) {
      ...
      heap.enqueue(newIndex, combined);
    }

    const root = heap.dequeue().node;
