...
(function(global) {
  ...
  if (isNode) {
    ...
    const cipherModules = [
      ...
      './algorithms/asymmetric/bike.js',
      './algorithms/asymmetric/classic-mceliece.js',
      './algorithms/asymmetric/cross.js',
      './algorithms/asymmetric/dilithium.js',
      './algorithms/asymmetric/faest.js',
      './algorithms/asymmetric/falcon.js',
      './algorithms/asymmetric/frodokem.js',
      './algorithms/asymmetric/hawk.js',
      './algorithms/asymmetric/hqc.js',
      './algorithms/asymmetric/lwe-signature.js',
      './algorithms/asymmetric/mayo.js',
      './algorithms/asymmetric/ml-dsa.js',
      './algorithms/asymmetric/ml-kem.js',
      './algorithms/asymmetric/ntru.js',
      './algorithms/asymmetric/perk.js',
      './algorithms/asymmetric/rainbow.js',
      './algorithms/asymmetric/rsa.js',
      './algorithms/asymmetric/sike.js',
      './algorithms/asymmetric/slh-dsa.js',
      './algorithms/asymmetric/sphincs-plus.js',
      './algorithms/asymmetric/sqisign.js',
      ...
      './algorithms/block/doubleking.js',
      ...
      './algorithms/block/thx.js',
      './algorithms/block/twofish.js',
      './algorithms/block/xtea.js',
      './algorithms/block/xxtea.js',
      './algorithms/classical/affine.js',
      './algorithms/classical/al-kindi-frequency.js',
      './algorithms/classical/autokey.js',
      './algorithms/classical/bazeries.js',
      './algorithms/classical/beaufort.js',
      './algorithms/classical/bifid.js',
      './algorithms/classical/cadaenus.js',
      './algorithms/classical/caesar.js',
      './algorithms/classical/columnar.js',
      './algorithms/classical/enigma.js',
      './algorithms/classical/foursquare.js',
      './algorithms/classical/gronsfeld.js',
      './algorithms/classical/hill.js',
      './algorithms/classical/jefferson-wheel.js',
      './algorithms/classical/nihilist.js',
      './algorithms/classical/phillips.js',
      './algorithms/classical/pigpen.js',
      './algorithms/classical/playfair.js',
      './algorithms/classical/polybius.js',
      './algorithms/classical/porta.js',
      './algorithms/classical/railfence.js',
      './algorithms/classical/scytale.js',
      './algorithms/classical/solitaire.js',
      './algorithms/classical/trifid.js',
      './algorithms/classical/twosquare.js',
      './algorithms/classical/vigenere.js',
      './algorithms/compression/arithmetic.js',
      ...
      './algorithms/encoding/yenc.js',
      './algorithms/encoding/z85.js',
      './algorithms/checksum/fletcher32.js',
      './algorithms/ecc/bch.js',
      './algorithms/ecc/hamming.js',
      './algorithms/ecc/ldpc.js',
      './algorithms/ecc/reed-solomon.js',
      './algorithms/hash/adler32.js',
      './algorithms/hash/argon2.js',
      './algorithms/hash/bcrypt.js',
      './algorithms/hash/blake2b.js',
      './algorithms/hash/blake2s.js',
      './algorithms/hash/blake3-enhanced.js',
      './algorithms/hash/blake3.js',
      './algorithms/hash/crc16.js',
      './algorithms/hash/crc32.js',
      './algorithms/hash/cityhash.js',
      './algorithms/hash/fnv.js',
      './algorithms/hash/groestl.js',
      './algorithms/hash/haval.js',
      './algorithms/hash/highway-hash.js',
      './algorithms/hash/jh.js',
      './algorithms/hash/md2.js',
      './algorithms/hash/md4.js',
      './algorithms/hash/md5.js',
      './algorithms/hash/murmurhash3.js',
      './algorithms/hash/ripemd160.js',
      './algorithms/hash/ripemd256.js',
      './algorithms/hash/ripemd320.js',
      './algorithms/hash/radiogatun.js',
      ...
      './algorithms/hash/skein.js',
      './algorithms/hash/streebog.js',
      './algorithms/hash/tiger.js',
      './algorithms/hash/whirlpool.js',
      './algorithms/hash/xxhash.js',
      './algorithms/hash/xxhash3.js',
      './algorithms/hash/xxhash32.js',
      './algorithms/kdf/argon2.js',
      './algorithms/kdf/hkdf.js',
      './algorithms/kdf/pbkdf2.js',
      './algorithms/kdf/scrypt.js',
      './algorithms/mac/cmac.js',
      './algorithms/mac/gmac.js',
      './algorithms/mac/hmac.js',
      './algorithms/mac/omac.js',
      './algorithms/mac/poly1305.js',
      './algorithms/mac/vmac.js',
      './algorithms/mode/ocb3.js',
      './algorithms/pqc/ml-kem.js',
      './algorithms/special/3way.js',
      './algorithms/special/aegis-128.js',
      './algorithms/special/aes-gcm-siv.js',
      './algorithms/special/aes-siv.js',
      './algorithms/special/ascon-128.js',
      './algorithms/special/ascon.js',
      './algorithms/special/ccm.js',
      './algorithms/special/chacha20-poly1305.js',
      './algorithms/special/eax.js',
      './algorithms/special/fiat-shamir.js',
      './algorithms/special/fish.js',
      './algorithms/special/gimli.js',
      './algorithms/special/ocb.js',
      './algorithms/special/ocb3.js',
      './algorithms/special/shamir-secret-sharing.js',
      './algorithms/special/time-lock-puzzle.js',
      ...
      './algorithms/stream/aegis-128.js',
      './algorithms/stream/aes-gcm-siv.js',
      './algorithms/stream/ascon.js',
      './algorithms/stream/chacha20.js',
      './algorithms/stream/chacha20-poly1305.js',
      './algorithms/stream/crypto1.js',
      './algorithms/stream/e0.js',
      './algorithms/stream/e2.js',
      './algorithms/stream/dragon.js',
      ...
      './algorithms/stream/hc-256.js',
      './algorithms/stream/isaac.js',
      './algorithms/stream/leviathan.js',
      './algorithms/stream/mickey.js',
      './algorithms/stream/mickey-128.js',
      './algorithms/stream/miller.js',
      './algorithms/stream/morus.js',
      './algorithms/stream/mugi.js',
      './algorithms/stream/new-stream-cipher-test-vectors.js',
      './algorithms/stream/norx.js',
      './algorithms/stream/panama.js',
      './algorithms/stream/phelix-simple.js',
      './algorithms/stream/pike.js',
      './algorithms/stream/pomaranch.js',
      ...
      './algorithms/stream/tsc-4.js',
      './algorithms/stream/test-new-stream-ciphers.js',
      './algorithms/stream/vest.js',
      './algorithms/stream/wake.js',
      './algorithms/stream/xchacha20-poly1305.js',
      './algorithms/stream/xchacha20.js',
      './algorithms/stream/xsalsa20.js',
      './algorithms/stream/zuc.js',
      // Mode algorithms from algorithms/modes/
      './algorithms/modes/cbc.js',
      './algorithms/modes/ccm.js', 
      './algorithms/modes/cfb.js',
      './algorithms/modes/cmc.js',
      './algorithms/modes/ctr.js',
      './algorithms/modes/cts.js',
      './algorithms/modes/eax.js',
      './algorithms/modes/ecb.js',
      './algorithms/modes/eme.js',
      './algorithms/modes/ffx.js',
      './algorithms/modes/fpe.js',
      './algorithms/modes/gcm-siv.js',
      './algorithms/modes/gcm.js',
      './algorithms/modes/ige.js',
      './algorithms/modes/kw.js',
      './algorithms/modes/kwp.js',
      './algorithms/modes/lrw.js',
      './algorithms/modes/ocb.js',
      './algorithms/modes/ofb.js',
      './algorithms/modes/pcbc.js',
      './algorithms/modes/siv.js',
      './algorithms/modes/xex.js',
      './algorithms/modes/xts.js',
      // Padding algorithms from algorithms/padding/
      './algorithms/padding/ansi-x923.js',
      './algorithms/padding/bit-padding.js',
      './algorithms/padding/iso10126.js',
      './algorithms/padding/iso7816-4.js',
      './algorithms/padding/no-padding.js',
      './algorithms/padding/oaep.js',
      './algorithms/padding/pkcs1.js',
      './algorithms/padding/pkcs5.js',
      './algorithms/padding/pkcs7.js',
      './algorithms/padding/pss.js',
      './algorithms/padding/random.js',
      './algorithms/padding/zero.js'
    ];
