...
| block                        | HPC                            | Rich Schroeppel                             | 1998        | AES candidate, DarkCrypt                        | GitHub iscgar/hasty-pudding      | ✅            | ✅ `hpc.js` (all 5 sub-ciphers)               |
...
| stream                       | Panama                         | Joan Daemen, Craig Clapp                    | 1998        | Academic                                        | Crypto++, Reference C code       | ✅            | ✅ `panama.js` (2/2 Crypto++ vectors, 100%) |
...
| stream                       | WAKE                           | David Wheeler                               | 1993        | Academic                                        | Crypto++                         | ✅            | ✅ `wake.js` (2/2 Crypto++ vectors, 100%)    |
...
| mac                          | BLAKE2b-MAC                    | Aumasson, Neves, Wilcox-O'Hearn, Winnerlein | 2012        | RFC 7693 (Keyed mode)                           | Botan, OpenSSL                   | ✅            | ✅ `blake2bmac.js`                           |
| mac                          | BLAKE3-MAC                     | O'Connor, Aumasson, Neves, Wilcox-O'Hearn   | 2020        | BLAKE3 specification (Keyed mode)               | Reference implementation         | ✅            | ✅ `blake3mac.js`                            |
...
| asymmetric                   | BIKE                           | Aragon et al.                               | 2017        | NIST PQC                                        | Reference implementation         | ✅            | ❌ Missing - needs QC-MDPC keys + bit-flip decoder |
| asymmetric                   | Classic McEliece               | Bernstein et al.                            | 1978/2017   | NIST PQC                                        | Reference implementation         | ✅            | ❌ Missing - needs Goppa keygen + Patterson decoding |
...
| asymmetric                   | HQC                            | Melchor et al.                              | 2017        | NIST PQC                                        | Reference implementation         | ✅            | ❌ Missing - needs concatenated RM/RS decoder |
...
| asymmetric                   | NTRU                           | Hoffstein et al.                            | 1996        | IEEE P1363.1                                    | NTRUOpenSourceProject            | ✅            | ❌ Missing - needs truncated polynomial ring |
...
| asymmetric                   | SIKE                           | Jao et al.                                  | 2011        | NIST PQC (broken)                               | Reference implementation         | ✅            | ❌ Not planned - broken by Castryck-Decru (eprint 2022/975) |
...
| padding                      | One and Zeros Padding          | ISO/IEC                                     | 1999        | ISO/IEC 9797-1 Padding Method 2                 | Botan                            | ✅            | ✅ `oneandzeros.js`                          |
...
| special                      | HOTP                           | M'Raihi, Bellare, Hoornaert, Naccache, Ranen | 2005        | RFC 4226 (HMAC-Based OTP)                       | Botan                            | ✅            | ✅ `hotp.js`                                 |
...
| special                      | TOTP                           | M'Raihi, Rydell, Pei, Machani               | 2011        | RFC 6238 (Time-Based OTP)                       | Botan                            | ✅            | ✅ `totp.js`                                 |
...
* **Total Algorithms Tracked**: 333 current implementations + 70+ newly researched = **403+ algorithms**
* **Fully Functional**: ~248 algorithms (61%)
...
| **Block Ciphers**      | 91      | 7+           | 98+   | Medium (missing finalists) |
