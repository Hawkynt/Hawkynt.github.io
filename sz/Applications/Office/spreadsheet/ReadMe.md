...
- [x] As a user, I can use Page Up/Page Down to jump through large sections of the grid
- [x] As a user, I can use Ctrl+Home/End to jump to the first/last used cell
...
- [x] As a user, I can paste data from external sources (external clipboard) into the grid
...
- [x] As a user, I can embed charts inline within the spreadsheet grid with live data binding
- [x] As a user, I can customize chart colors, labels, and legends via a chart options dialog
- [x] As a user, I can right-click a chart to access a context menu for editing, resizing, or removing the chart
...
### Context Menu
- [x] As a user, I can right-click a cell to access a context menu with Cut, Copy, Paste, Delete, Insert Row/Column, Sort Ascending/Descending
