...
- [x] As a user, I can insert shapes (rectangle, circle, line, arrow, star, triangle, diamond, pentagon, hexagon, heart, and more) via the shape tools module (`shape-tools.js`)
- [x] As a user, I can interact with inserted shapes (select, move, resize, delete) using the shape-tools.js module
...
- [x] As a user, I can see match count and current match position in the enhanced find/replace panel
...
### Status Bar
- [x] As a user, I can see the word count in the status bar updated in real time as I type
- [x] As a user, I can see the character count in the status bar updated in real time as I type
...
### Text Context Menu
- [x] As a user, I can right-click in the text editor to access a context menu with Cut, Copy, Paste, Bold, Italic, Underline, and text alignment options

### Equation Editor
- [x] As a user, I can insert and edit mathematical equations with a visual equation editor dialog
- [x] As a user, I can use common math symbols, fractions, roots, integrals, and Greek letters in equations
