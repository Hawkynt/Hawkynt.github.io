;(function() {
  ...
  // =====================================================================
  // Syntax highlighting (shared module aliases)
  // =====================================================================
  const { LANG_NAMES, EXT_TO_LANG, buildRules, escapeHtml } = SZ.SyntaxHighlighter;
  ...
  function highlightLine(line) {
    return SZ.SyntaxHighlighter.highlightLine(line, currentRules);
  }
  ...
  function showGotoLine() {
    ...
    SZ.Dialog.show('dlg-goto').then((result) => {
      input.removeEventListener('keydown', handleKey);
      if (result === 'ok')
        doGoto();
      editor.focus();
  ...
  function showFontDialog() {
    ...
    SZ.Dialog.show('dlg-font').then((result) => {
  ...
  function showTabSettings() {
    ...
    SZ.Dialog.show('dlg-tab-settings').then((result) => {
      if (result !== 'ok')
        return;
