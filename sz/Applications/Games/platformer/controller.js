;(function() {
  ...
  const TUTORIAL_PAGES = [
    { title: 'How to Play', lines: ['Run, jump, and stomp enemies!', 'Collect coins and reach the flag.', '', 'Left/Right or A/D = Move', 'Up / W / Space = Jump', 'Z = Fireball (with power-up)'] },
    { title: 'Tips', lines: ['Stomp enemies from above to defeat them.', 'Collect mushroom power-ups to grow big.', 'Fire flowers let you throw fireballs!', '', 'Watch out for flying and shooting enemies.', 'Press H anytime to see this help again.'] }
  ];
