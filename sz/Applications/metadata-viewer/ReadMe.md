...
- [x] MSIL stack-tracking decompiler: C# 2.0-style output (Pseudo-C#), VB.NET syntax (Pseudo-VB), and modern C# with heuristic pattern detection for async/await, yield, lambdas, and compiler sugar (C# simplified)
