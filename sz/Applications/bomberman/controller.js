;(function() {
  ...
  // Each character row has 10 cols: 2 frames per direction in cols 0-7, extras in 8-9
  // Layout: cols 0,1=down  2,3=up  4,5=left  6,7=right
  function _buildCharFrames(startRow) {
    const dirCols = [[0, 1], [2, 3], [4, 5], [6, 7]];
  ...
  function updateEnemy(enemy, dt) {
    ...
    enemy.facing = chosen.dy < 0 ? 1 : chosen.dy > 0 ? 0 : chosen.dx < 0 ? 2 : 3;
    enemy.walkTimer = 0;
  }
