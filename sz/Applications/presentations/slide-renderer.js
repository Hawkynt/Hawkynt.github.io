;(function() {
  ...
  const LAYOUT_PLACEHOLDERS = {
    'title': [
      { role: 'title', x: 160, y: 180, w: 640, h: 80 },
      { role: 'subtitle', x: 240, y: 300, w: 480, h: 40 }
    ],
    'title-content': [
      { role: 'title', x: 50, y: 20, w: 860, h: 60 },
      { role: 'content', x: 50, y: 100, w: 860, h: 420 }
    ],
    'section': [
      { role: 'header', x: 100, y: 200, w: 760, h: 60 },
      { role: 'subtext', x: 200, y: 280, w: 560, h: 40 }
    ],
    'blank': [],
    'two-content': [
      { role: 'title', x: 50, y: 20, w: 860, h: 60 },
      { role: 'left', x: 50, y: 100, w: 410, h: 420 },
      { role: 'right', x: 500, y: 100, w: 410, h: 420 }
    ],
    'comparison': [
      { role: 'title', x: 50, y: 20, w: 860, h: 60 },
      { role: 'left-header', x: 50, y: 80, w: 410, h: 30 },
      { role: 'left-content', x: 50, y: 120, w: 410, h: 400 },
      { role: 'right-header', x: 500, y: 80, w: 410, h: 30 },
      { role: 'right-content', x: 500, y: 120, w: 410, h: 400 }
    ]
  };
